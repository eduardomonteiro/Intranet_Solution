    ...
    init: function (area) {
        ...
        var init = function () {
            ...
            $("#frmBuscaContato").unbind('submit').submit(function () {
                $("#divContato").html("<img src='/images/carregando.gif'/>");
                $("#divContato").load("/Contato/Lista/" + area, { busca: $("#palavrachave").val(), empreendimento: $("#Empreendimento").val() }, function () {
                    init();
                });
                return false;
            });
            ...
            $("#btnAbertos").unbind('click').click(function () {
                ...
                $("#divContato").html("<img src='/images/carregando.gif'/>");
                $("#divContato").load("/Contato/Lista/" + area, { busca: $("#Busca").val(), empreendimento: $("#Empreendimento").val(), finalizado: false }, function () {
                    init();
                });
            });
            ...
            $("#btnFinalizados").unbind('click').click(function () {
                ...
                $(this).addClass("active");
                $("#divContato").html("<img src='/images/carregando.gif'/>");
                $("#divContato").load("/Contato/Lista/" + area, { busca: $("#Busca").val(), empreendimento: $("#Empreendimento").val(), finalizado: true }, function () {
                    init();
                });
            });
            ...
            $("#btnTodos").unbind('click').click(function () {
                ...
                $(this).addClass("active");
                $("#divContato").html("<img src='/images/carregando.gif'/>");
                $("#divContato").load("/Contato/Lista/" + area, { busca: $("#Busca").val(), empreendimento: $("#Empreendimento").val() }, function () {
                    init();
                });
            });
        };
